...
- [gesellix/couchdb-prometheus-exporter](https://github.com/gesellix/couchdb-prometheus-exporter) ([v30.9.5](https://github.com/gesellix/couchdb-prometheus-exporter/releases/tag/v30.9.5), 4 days ago) - CouchDB stats exporter for Prometheus
- [gesellix/slack-notify-action](https://github.com/gesellix/slack-notify-action) ([v0.0.3](https://github.com/gesellix/slack-notify-action/releases/tag/v0.0.3), 4 days ago) - Send Notifications to Slack in a GitHub Workflow
