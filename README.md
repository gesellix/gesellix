...
- [gesellix/Bose-SoundTouch](https://github.com/gesellix/Bose-SoundTouch) ([v0.123.0](https://github.com/gesellix/Bose-SoundTouch/releases/tag/v0.123.0), 2 days ago) - Controlling and preserving Bose SoundTouch devices
- [gesellix/go-trmnl](https://github.com/gesellix/go-trmnl) ([v0.3.0](https://github.com/gesellix/go-trmnl/releases/tag/v0.3.0), 3 days ago) - A self-hosted BYOS (Build Your Own Server) for the TRMNL e-ink display
