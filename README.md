...
- [gesellix/Bose-SoundTouch](https://github.com/gesellix/Bose-SoundTouch) ([v0.9.0](https://github.com/gesellix/Bose-SoundTouch/releases/tag/v0.9.0), 2 days ago) - A modern Go library and CLI tool for interacting with Bose SoundTouch devices via their Web API.
