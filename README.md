...
- [gesellix/Bose-SoundTouch](https://github.com/gesellix/Bose-SoundTouch) ([v0.92.0](https://github.com/gesellix/Bose-SoundTouch/releases/tag/v0.92.0), 1 day ago) - Controlling and preserving Bose SoundTouch devices
- [gesellix/gioui-splash](https://github.com/gesellix/gioui-splash) ([v0.10.1](https://github.com/gesellix/gioui-splash/releases/tag/v0.10.1), 5 days ago) - A cross-platform splash screen for Go, based on Gio UI
...
- [AfterTouch: Keeping Bose SoundTouch Speakers Fully Featured After the Cloud Shutdown](https://www.gesellix.net/posts/aftertouch-bose-soundtouch/) (2 weeks ago)
