...
- [testcontainers/testcontainers-java](https://github.com/testcontainers/testcontainers-java) ([1.18.2](https://github.com/testcontainers/testcontainers-java/releases/tag/1.18.2), today) - Testcontainers is a Java library that supports JUnit tests, providing lightweight, throwaway instances of common databases, Selenium web browsers, or anything else that can run in a Docker container.
- [gesellix/artifact-diff](https://github.com/gesellix/artifact-diff) ([v0.2.2](https://github.com/gesellix/artifact-diff/releases/tag/v0.2.2), 3 days ago) - Compare directories and zip/jar artifacts
- [integrations/terraform-provider-github](https://github.com/integrations/terraform-provider-github) ([v5.25.1](https://github.com/integrations/terraform-provider-github/releases/tag/v5.25.1), 1 week ago) - Terraform GitHub provider
...
- [docker-client/docker-compose-v3](https://github.com/docker-client/docker-compose-v3) ([v2023-05-01T14-09-00](https://github.com/docker-client/docker-compose-v3/releases/tag/v2023-05-01T14-09-00), 4 weeks ago) - 
- [docker-client/docker-filesocket](https://github.com/docker-client/docker-filesocket) ([v2023-05-01T14-07-00](https://github.com/docker-client/docker-filesocket/releases/tag/v2023-05-01T14-07-00), 4 weeks ago) - Unix domain socket and named pipe abstraction for the docker-client
