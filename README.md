...
- [gesellix/gioui-splash](https://github.com/gesellix/gioui-splash) ([v0.2.0](https://github.com/gesellix/gioui-splash/releases/tag/v0.2.0), 3 days ago) - A cross-platform splash screen for Go, based on Gio UI
- [integrations/terraform-provider-github](https://github.com/integrations/terraform-provider-github) ([v5.28.1](https://github.com/integrations/terraform-provider-github/releases/tag/v5.28.1), 5 days ago) - Terraform GitHub provider
- [gesellix/couchdb-client](https://github.com/gesellix/couchdb-client) ([v2023-06-22T18-05-00](https://github.com/gesellix/couchdb-client/releases/tag/v2023-06-22T18-05-00), 5 days ago) - A CouchDB client written in Groovy
- [gesellix/couchdb-prometheus-exporter](https://github.com/gesellix/couchdb-prometheus-exporter) ([v30.6.1](https://github.com/gesellix/couchdb-prometheus-exporter/releases/tag/v30.6.1), 5 days ago) - CouchDB stats exporter for Prometheus
...
- [jeremylong/DependencyCheck](https://github.com/jeremylong/DependencyCheck) ([v8.3.1](https://github.com/jeremylong/DependencyCheck/releases/tag/v8.3.1), 2 weeks ago) - OWASP dependency-check is a software composition analysis utility that detects publicly disclosed vulnerabilities in application dependencies.
...
- [gesellix/artifact-diff](https://github.com/gesellix/artifact-diff) ([v0.2.2](https://github.com/gesellix/artifact-diff/releases/tag/v0.2.2), 1 month ago) - Compare directories and zip/jar artifacts
