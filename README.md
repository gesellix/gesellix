...
- [moby/moby](https://github.com/moby/moby) ([v20.10.10](https://github.com/moby/moby/releases/tag/v20.10.10), 2 days ago) - Moby Project - a collaborative project for the container ecosystem to assemble container-based systems
- [spring-projects/spring-boot](https://github.com/spring-projects/spring-boot) ([v2.6.0-RC1](https://github.com/spring-projects/spring-boot/releases/tag/v2.6.0-RC1), 6 days ago) - Spring Boot
