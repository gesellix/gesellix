...
- [gesellix/Bose-SoundTouch](https://github.com/gesellix/Bose-SoundTouch) ([v0.5.3](https://github.com/gesellix/Bose-SoundTouch/releases/tag/v0.5.3), today) - A modern Go library and CLI tool for interacting with Bose SoundTouch devices via their Web API.
