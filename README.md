...
- [gesellix/go-trmnl](https://github.com/gesellix/go-trmnl) ([v0.8.0](https://github.com/gesellix/go-trmnl/releases/tag/v0.8.0), 1 day ago) - A self-hosted BYOS (Build Your Own Server) for the TRMNL e-ink display
- [gesellix/Bose-SoundTouch](https://github.com/gesellix/Bose-SoundTouch) ([v0.137.1](https://github.com/gesellix/Bose-SoundTouch/releases/tag/v0.137.1), 5 days ago) - Controlling and preserving Bose SoundTouch devices
