...
- [integrations/terraform-provider-github](https://github.com/integrations/terraform-provider-github) ([v5.9.1](https://github.com/integrations/terraform-provider-github/releases/tag/v5.9.1), 1 day ago) - Terraform GitHub provider
- [jeremylong/DependencyCheck](https://github.com/jeremylong/DependencyCheck) ([v7.3.2](https://github.com/jeremylong/DependencyCheck/releases/tag/v7.3.2), 5 days ago) - OWASP dependency-check is a software composition analysis utility that detects publicly disclosed vulnerabilities in application dependencies.
