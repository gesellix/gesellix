...
- [openjdk/jdk8u-dev](https://github.com/openjdk/jdk8u-dev) - https://wiki.openjdk.org/display/jdk8u (today)
...
- [gesellix/gioui-splash](https://github.com/gesellix/gioui-splash) ([v0.2.2](https://github.com/gesellix/gioui-splash/releases/tag/v0.2.2), 1 day ago) - A cross-platform splash screen for Go, based on Gio UI
- [gesellix/titlelink](https://github.com/gesellix/titlelink) ([v3.8.0](https://github.com/gesellix/titlelink/releases/tag/v3.8.0), 6 days ago) - Joomla! TitleLink plugin
