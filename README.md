...
- [europace/docker-publish-gradle-plugin](https://github.com/europace/docker-publish-gradle-plugin) ([v1.1.0](https://github.com/europace/docker-publish-gradle-plugin/releases/tag/v1.1.0), 2 days ago) - Plugin to create and publish a docker image of a spring-boot-service
- [moby/moby](https://github.com/moby/moby) ([v20.10.12](https://github.com/moby/moby/releases/tag/v20.10.12), 6 days ago) - Moby Project - a collaborative project for the container ecosystem to assemble container-based systems
