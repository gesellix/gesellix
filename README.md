...
- [gesellix/go-trmnl](https://github.com/gesellix/go-trmnl) ([v0.5.0](https://github.com/gesellix/go-trmnl/releases/tag/v0.5.0), 1 day ago) - A self-hosted BYOS (Build Your Own Server) for the TRMNL e-ink display
- [gesellix/Bose-SoundTouch](https://github.com/gesellix/Bose-SoundTouch) ([v0.136.0](https://github.com/gesellix/Bose-SoundTouch/releases/tag/v0.136.0), 3 days ago) - Controlling and preserving Bose SoundTouch devices
