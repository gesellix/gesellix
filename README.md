...
- [gesellix/Bose-SoundTouch](https://github.com/gesellix/Bose-SoundTouch) ([v0.6.0](https://github.com/gesellix/Bose-SoundTouch/releases/tag/v0.6.0), 1 day ago) - A modern Go library and CLI tool for interacting with Bose SoundTouch devices via their Web API.
- [gesellix/couchdb-prometheus-exporter](https://github.com/gesellix/couchdb-prometheus-exporter) ([v30.16.0](https://github.com/gesellix/couchdb-prometheus-exporter/releases/tag/v30.16.0), 6 days ago) - CouchDB stats exporter for Prometheus
