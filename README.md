...
- [moby/moby](https://github.com/moby/moby) ([v24.0.1](https://github.com/moby/moby/releases/tag/v24.0.1), 2 days ago) - Moby Project - a collaborative project for the container ecosystem to assemble container-based systems
- [integrations/terraform-provider-github](https://github.com/integrations/terraform-provider-github) ([v5.25.1](https://github.com/integrations/terraform-provider-github/releases/tag/v5.25.1), 3 days ago) - Terraform GitHub provider
- [gesellix/artifact-diff](https://github.com/gesellix/artifact-diff) ([v0.1.2](https://github.com/gesellix/artifact-diff/releases/tag/v0.1.2), 6 days ago) - Compare directories and zip/jar artifacts
...
- [gesellix/docker-client](https://github.com/gesellix/docker-client) ([v2023-05-07T23-22-00](https://github.com/gesellix/docker-client/releases/tag/v2023-05-07T23-22-00), 2 weeks ago) - A Docker client for Java written in Kotlin and Groovy
