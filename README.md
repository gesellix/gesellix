...
- [krahl/soundcork-stockholm-app](https://github.com/krahl/soundcork-stockholm-app) - Run SoundTouch Stockholm with self-hosted backend (6 days ago)
...
- [gesellix/Bose-SoundTouch](https://github.com/gesellix/Bose-SoundTouch) ([v0.74.0](https://github.com/gesellix/Bose-SoundTouch/releases/tag/v0.74.0), 1 day ago) - Controlling and preserving Bose SoundTouch devices
- [europace/docker-publish-gradle-plugin](https://github.com/europace/docker-publish-gradle-plugin) ([v2.0.19](https://github.com/europace/docker-publish-gradle-plugin/releases/tag/v2.0.19), 6 days ago) - Plugin to create and publish a docker image of a spring-boot-service
...
- [AfterTouch: Keeping Bose SoundTouch Speakers Fully Featured After the Cloud Shutdown](https://www.gesellix.net/posts/aftertouch-bose-soundtouch/) (6 days ago)
