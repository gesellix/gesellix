...
- [integrations/terraform-provider-github](https://github.com/integrations/terraform-provider-github) ([v5.22.0](https://github.com/integrations/terraform-provider-github/releases/tag/v5.22.0), 1 day ago) - Terraform GitHub provider
- [europace/docker-publish-gradle-plugin](https://github.com/europace/docker-publish-gradle-plugin) ([v1.4.3](https://github.com/europace/docker-publish-gradle-plugin/releases/tag/v1.4.3), 1 day ago) - Plugin to create and publish a docker image of a spring-boot-service
